...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" onclick="return confirm('Bạn có chắc muốn đăng xuất không?')" href="<?= BASE_URL_ADMIN ?>&act=logout">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
        ...
        <script src="<?= BASE_ASSETS_ADMIN ?>assets/demo/chart-area-demo.js"></script>
        <script src="<?= BASE_ASSETS_ADMIN ?>assets/demo/chart-bar-demo.js"></script>
